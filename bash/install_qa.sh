...
wget https://gitee.com/xiongyifan/imgRes/raw/master/docker-compose.yaml  # 不会覆盖已有文件
# wget https://gitee.com/xiongyifan/imgRes/raw/master/docker-compose.yaml -O docker-compose.yaml  # 会覆盖已有文件
# Step 2: 创建数据卷
